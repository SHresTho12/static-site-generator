...
from text_splitter import split_nodes_delimiter , extract_markdown_images , extract_markdown_links, split_nodes_image , split_nodes_link,text_to_textnodes
...
class TestTextToTextNodes(unittest.TestCase):
    ...
    def test_link_and_image(self):
        self.assertEqual(
            text_to_textnodes("![img](img.jpg) and [click](url.com)"),
            [
